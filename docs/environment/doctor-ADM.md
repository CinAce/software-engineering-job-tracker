## ITC 531 environment check — 2026-09-07 01:04 UTC
...
Memory
  warn 7803 MB visible. Workable, but run one module's stack at a time — 'docker compose down --volumes' before starting the next.

Ports the course uses

Working directory
   ok  /home/alber/itc531
